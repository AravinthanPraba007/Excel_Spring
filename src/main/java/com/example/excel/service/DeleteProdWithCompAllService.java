...
import com.example.excel.deleteProdHelper.WithCompAllDataBuilder;
import com.example.excel.helper.CellInputFormatHelper;

@Service
public class DeleteProdWithCompAllService {
	
	@Autowired
	WithCompAllDataBuilder dataBuilder;
...
//	CellInputFormatHelper cellFormatorHelper;
	   ...
	   public ByteArrayInputStream loadFile(MultipartFile file) {
		   System.out.println("Entering DeleteProdWithCompAllService");
		   
		   Map<String, List<String>> prod_lst_data = new HashMap<String, List<String>>();
		   
//		1. Parse the excel to list of data
		try {
			System.out.println("Entering DeleteProdWithCompAllService parseExcelFile ");
